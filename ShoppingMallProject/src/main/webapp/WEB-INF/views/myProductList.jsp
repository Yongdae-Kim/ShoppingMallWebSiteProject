...
<title>OpenMarket My Upload Product List</title>
	...
	<section>
		<div class="container">
			<div class="page-header">
				<h1>
					My Upload Product List <br> <small>If you want to
						delete a product, Click the 'Delete' button.</small>
				</h1>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">my Upload Product List Tables</div>
									...
									<tbody>
										<c:forEach var="product" items="${productList}"
											...
											<tr>
												...
												<td><form action="productModify" method="POST">
														<input type="hidden" name="productId"
															value="${product.id}" /> <input class="btn btn-warning"
															type="submit" value="Modify" />
													</form></td>
												<td><form action="myProductList" method="POST">
														<input type="hidden" name="productId"
